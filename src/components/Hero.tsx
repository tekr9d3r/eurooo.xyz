      ...
      <div className="container">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-24 opacity-0 animate-fade-in-up animation-delay-600">
            <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-secondary/80 via-secondary/50 to-transparent p-8 sm:p-12">
              ...
              <div className="relative z-10 flex flex-col items-center gap-6 text-center">
                {/* Telegram Icon */}
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#0088cc]/10 transition-transform duration-300 hover:scale-110">
...
EUR deserves better in DeFi. Think together. 
                ...
                <a href="https://t.me/+wxIKk-lsEy5kMGQ0" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full bg-[#0088cc] px-6 py-3 text-white font-medium transition-all duration-300 hover:bg-[#0077b5] hover:shadow-lg hover:shadow-[#0088cc]/25 hover:-translate-y-0.5">
